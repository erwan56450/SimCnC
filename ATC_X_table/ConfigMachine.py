...
# pour le logiciel SIMCNC avec un controler Csmio-s ip7
...
every_time_get_measure = True       # true = mesure a tous les coups, False = mesure que si la table d'outil est a zero 
...
probeIndex = 0                      # corespond a l'entrée que vous avez configuré dans les settings de simcnc (settings->Modules->IO Signals  : 0,1,2 ou 3 possible)
